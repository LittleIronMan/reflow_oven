...
void StartDefaultTask(void const * argument)
{
	...
	for (;;)
	{
		...
		if (err2 != 0) {
			printf("Receive error, errcode == %u\n", (uint8_t)err2);
		}
		else {
			uint8_t coupleDisconnected = 1;
...
int main(void)
{
	...
	xTaskCreate(StartDefaultTask, "default", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 3, &taskHandle);
